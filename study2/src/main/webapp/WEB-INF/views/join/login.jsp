...
<div class="page-header">
   ...
   <%-- 
   <form:errors path="member" /> : 전역에러 메시지 출력   
   <form:errors path="member.id" /> : 해당 필드 메시지 
   <form:errors path="member.*" /> : 전역 및 필드 에러 메시지 출력
    --%>
</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label">패스위드</label>
    <div class="col-sm-10">
